<template>
  <div class="conters">
    ...
    <ul class="col3">
      <li>
        <a href="#" class="countersOptionButton" @click.prevent="clearItem"
          >Clear</a
        >
      </li>
      <li>
        <a
          v-if="false"
          href="#"
          class="countersOptionButton"
          @click.prevent="resetItem"
          >Reset</a
        >
      </li>
      <li>
        <a href="#" class="countersOptionButton" @click.prevent="addItem"
          >Add</a
        >
      </li>
    </ul>
  ...
  methods: {
    ...
    resetItem() {
      this.items.forEach(function (item, index) {
        // TODO: カウンターを一括クリアしたいですが、うまく動作しないため検証中です。
        item.value = 0;
      });
    },
    clearItem() {
